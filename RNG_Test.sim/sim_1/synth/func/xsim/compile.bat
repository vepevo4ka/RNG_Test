...
REM
REM Generated by Vivado on Wed Oct 30 21:32:58 +0300 2024
...
echo "xvlog --incr --relax -prj TB_SimpleRX_vlog.prj"
call xvlog  --incr --relax -prj TB_SimpleRX_vlog.prj -log xvlog.log
