...
HD_PWD='D:/arbeit/synchronization/RNG_Test/RNG_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SimpleRX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SimpleRX.tcl -notrace
