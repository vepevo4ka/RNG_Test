...
HD_PWD='D:/arbeit/synchronization/RNG_Test/RNG_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SimpleRX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SimpleRX.tcl
