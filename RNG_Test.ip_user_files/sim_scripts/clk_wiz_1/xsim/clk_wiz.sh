...
#
# Generated by Vivado on Thu Nov 14 21:55:10 +0300 2024
...
# Script info
echo -e "clk_wiz.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz xil_defaultlib.clk_wiz xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
